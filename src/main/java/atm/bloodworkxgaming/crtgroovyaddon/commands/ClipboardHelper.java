...
import atm.bloodworkxgaming.crtgroovyaddon.network.MessageCopyClipboard;
...
public class ClipboardHelper {
    ...
    static final String copyCommandBase = "/cg copy ";
    ...
    static void copyStringPlayer(EntityPlayer player, String s) {
        if(player instanceof EntityPlayerMP) {
            CrTGroovyAddon.NETWORK.sendTo(new MessageCopyClipboard(s), (EntityPlayerMP) player);
        }
    }
}